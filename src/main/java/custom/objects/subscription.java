...
public class subscription extends AbstractData {
	...
	public void setBibleVersion(String bibleVersion) {
		this.bibleVersion = this.setFieldAsString("bible_version", bibleVersion);
	}
	...
	public void setData(Row row) {
		...
		if (row.getFieldInfo("list") != null)
			this.setList(row.getFieldInfo("list").stringValue());
		if (row.getFieldInfo("available") != null)
			this.setAvailable(row.getFieldInfo("available").booleanValue());
		if (row.getFieldInfo("language") != null)
			this.setLanguage(row.getFieldInfo("language").stringValue());
		if (row.getFieldInfo("bible_version") != null)
			this.setBibleVersion(row.getFieldInfo("bible_version").stringValue());
	}
	...
	public String toString() {
		...
		buffer.append(",\"bible_version\":\"" + this.getBibleVersion() + "\"");
		buffer.append("}");
