...
public class dailymail extends AbstractApplication {
	...
	public boolean start() {
		...
		this.getConfiguration().set("default.base_url", "https://www.ingod.today/?q=");
			...
			public void start() {
				synchronized (o) {
					try {
						...
						buffer.append("				<a href=\"https://www.ingod.today/?lang=zh-CN&amp;q=feed/"+date_string+"\">每日读经 "+date_string+"</a>");
						buffer.append("			</h2>");
						buffer.append("			<div base=\"https://www.ingod.today/?lang=zh-CN&amp;q=feed\" class=\"feedEntryContent\">");
