...
/*		DatabaseOperator databaseOperator = new DatabaseOperator();
		databaseOperator.createStatement(false);
		databaseOperator.execute("ALTER TABLE bible.`User` MODIFY COLUMN password varchar(33) CHARACTER SET utf8 COLLATE utf8_general_ci NULL;\n");
