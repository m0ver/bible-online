...
var Book=function()
{
	this.old_books_node=document.getElementById(arguments[0].old_books_id);
	this.old_chapters_node=document.getElementById(arguments[0].old_chapters_id);
	
	this.new_books_node=document.getElementById(arguments[0].new_books_id);
	this.new_chapters_node=document.getElementById(arguments[0].new_chapters_id);
